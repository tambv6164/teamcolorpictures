...
class Savepicture(Document):
    ...
    piclikes = IntField(default=0) # số like, ban đầu mặc định là 0, tăng lên mỗi khi có ngươi like
    piccomments = IntField(default=0) # số comment, ban đầu mặc định là 0, tăng lên mỗi khi có người comment
    picartist = StringField() # tranh này tác giả là ai, ban đầu mặc định là None. Nếu người dùng click vào save thì sẽ tính là tranh của người đó
